...
- `ARCHITECTURE_RELATIONSHIPS.md` - How Principal, DA, Engines, Agents, Archetypes, Personas, Hooks, and Skills relate to each other | ⭐ CANONICAL | Triggers: "how does PAI work", "what's the difference between agents and engines", "archetypes vs personas", "architecture map"
