...
- Default structured tasks: `model: "ollama/nemotron-mini:latest"`
Only escalate to Claude (no model override) when Ollama quality is provably insufficient for the task.
