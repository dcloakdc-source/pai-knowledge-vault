...
> ⚠️ **STAGED — for a future Algorithm v6.2.0; NOT the active doctrine.** `Algorithm/LATEST` = v5.7.2. This file describes v6.2.0-era patterns staged ahead of the shipped doctrine; the active v5.7.2 doctrine governs. Reconcile/promote when v6.2.0 ships. *(Spine P2 stamp, 2026-05-30.)*
